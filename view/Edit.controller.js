...
sap.ui.controller("sap.ui.demo.myFiori.view.Edit", {
	...
	handleNavButtonPress : function (evt) {
			...
			tinyMCE.remove('.EditMyQuestions');
			sap.ui.getCore().byId("QuesCatEdit").setValue('');
			sap.ui.getCore().byId("QuesSubCatEdit").setValue('');
	...
	{		
			...
			sap.ui.getCore().byId("QuesSubCatEdit").setValue('');
						// navigate
		    sap.ui.getCore().byId("EditQuestion").getController().nav.to("Detail",sap.ui.getCore().byId("EditQuestion").getBindingContext());
	},
	...
	acceptButtonPress: function(evt) {
		this._content = tinymce.get('CreateQuestionTAEdit').getContent({format: 'raw'});;
		//alert(this._content);
		...
		//console.log(this.getView().getModel().getJSON());
     	...
     	this._QNstr=sap.ui.getCore().byId("EditQuestion").getBindingContext()+"";
     	this._i=(sap.ui.getCore().byId("EditQuestion").getBindingContext()+"").length-1;
		this._temp='';
		...
		this._QCat = sap.ui.getCore().byId("QuesCatEdit").getValue()+"";
		this._QScat = sap.ui.getCore().byId("QuesSubCatEdit").getValue()+"";
		//changed at
		this._d = new Date();
	...
	onAfterRendering: function() {
		...
		tinymce.init({
		        ...
		        init_instance_callback : function(editor) 
		        {
	        		...
	        		var init_content = sap.ui.getCore().getModel().getProperty(sap.ui.getCore().byId("Detail").getBindingContext()+"/QuesText");
